...
import numpy as np
import os #To connect to the OS
import six.moves.urllib as urllib#To make version control compactability
...
import zipfile
import time
import pytesseract #Character recognization
import engineio
